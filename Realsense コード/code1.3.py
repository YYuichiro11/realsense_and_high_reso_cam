...
while True:
    ...
    #複数カメラの静止画を保存
    cv2.putText(fisheye_image1_r,str(pose_frame_1.frame_number),(0,50),cv2.FONT_HERSHEY_PLAIN,2,(255,255,255),2,cv2.LINE_AA)
    cv2.putText(fisheye_image2_r,str(pose_frame_2.frame_number),(0,50),cv2.FONT_HERSHEY_PLAIN,2,(255,255,255),2,cv2.LINE_AA)
