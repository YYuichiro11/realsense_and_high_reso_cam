...
# ここからメイン実行文
movie1 = ['C:/graduation invastigation/information/camera1_2.mp4', True]     # 元動画のパス1, カラーはTrue
movie2 = ['C:/graduation invastigation/information/camera3_4.mp4', True]    # 元動画のパス2, 白黒はFalse
path_out = 'C:/graduation invastigation/information/camera1_4.mp4'        # 保存する動画のパス
